...
Ao término do projeto local, estaremos hospedando a aplicação no **[Firebase Real-Time](https://github.com/ScodeArruda/passaro-urbano)** tanto no lado do server e client-side!
